...
import { Activity, Bot, GitBranch, LayoutDashboard, MessageSquarePlus, ScanSearch } from "lucide-react";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen md:grid md:grid-cols-[240px_minmax(0,1fr)]">
    ...
    <div className="min-w-0">
      <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b bg-[#fbfbfa]/90 px-4 backdrop-blur md:px-7"><span className="mono text-xs uppercase tracking-[.14em] text-[#64717c]">workspace / periscope</span><RuntimeIndicator /></header>
